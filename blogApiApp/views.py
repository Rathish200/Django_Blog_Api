...
def DeletePost(request):
    ...
    try:
         ...
         post.delete()
         return Response({"Success":"the post is successfully deleted"}, status=200)
    except Post.DoesNotExist:
          return Response({"Error":"the post doesn't exist"}, status=404)
...
def UpdatePost(request):
    ...
    try:
         ...
         post.save()
         return Response({"Success":"The post was succssfull updated"}, status=200)
